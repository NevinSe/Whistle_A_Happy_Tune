...
function secondMaster(myObj){
    for (let i = 0; i < 10; i++)
    {
        if (i % 2 === 0)
        {
            document.getElementById(`${i}`).style = "background: linear-gradient(to right, lightgrey, dimgrey, lightgrey)";
        }
        else
        {
        ...
        document.getElementById(`albumCover${[i]}`).className = "imgBorder";
